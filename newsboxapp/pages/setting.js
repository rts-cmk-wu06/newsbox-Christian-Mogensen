...
const setting = () => {
  return (
    ...
    <main className="p-4 flex flex-col justify-between bg-[color:var(--Primary-clr-Setup)] wrapper">
      ...
      <div className='flex justify-center'><button className='font-[text:var(--Secondary-ff)] px-4 py-2 border border-[color:var(--btn-clr-border)] mt-10 rounded-3xl'>TOGGLE DARK MODE</button></div>
    </main>
    </div>
    </>
  );
